...
```{r}
PatientObservations <- read.csv(file.choose()) #load 2.1 PatientObservatios table
PatientSummary<- read.csv(file.choose()) # load 2.1 PatientSummary table
data("rules")
```
...
## Visualize the barplot of the phenotypes grouped by sex
...
## Visualize the barplot of the phenotypes grouped by age
